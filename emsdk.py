...
if machine.startswith('x64') or machine.startswith('amd64') or machine.startswith('x86_64'):
  ...
  ARCH = 'arm'
elif platform.machine().lower() == 'ppc64le':
  ARCH= 'ppc64le'
else:
...
def download_and_unzip(zipfile, dest_dir, download_even_if_exists=False,
  ...
  url="https://nodejs.org/dist/v12.9.1/node-v12.9.1-linux-ppc64le.tar.xz"
...
def main():
  ...
  if cmd == 'list':
    ...
    if (LINUX or OSX or WINDOWS) and (ARCH == 'x86' or ARCH == 'x86_64' or ARCH == 'ppc64le'):
